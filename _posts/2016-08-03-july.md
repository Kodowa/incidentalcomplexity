...
_This post has been updated. See the original [here](https://github.com/Kodowa/incidentalcomplexity/blob/f44a2392e15d78f9e0047f25054863f7418165b5/_posts/2016-08-03-july.md)._

### Eve Platform

Our biggest news this month is our community preview of Eve alpha. During May and June we were busy developing Eve in a secondary repository, trying to get it to a state that was more approachable and usable for outsiders. In July, we finally reached a point where we were happy to [invite the community](https://groups.google.com/forum/#!topic/eve-talk/riE6yy7bBeo) to play with the platform and provide usability feedback. So far we've received dozens of comments, issue reports, and suggestions. We're thrilled with the response, and want to thank everyone who has provided valuable feedback. Thanks to you, Eve is in a much better place compared to two weeks ago.

If you'd like to try Eve yourself, you can start at our main repository, [witheve/Eve](https://github.com/witheve/Eve).
...
Below is an analogue [clock in Eve](https://github.com/witheve/Eve/blob/c75727d86c0df367678eec6d7d1dd9a5d56c356b/examples/clock.eve) that reacts to changes in `#time`, which is an object in the system that represents the current time with `hours`, `minutes`, and `seconds`, attributes.
...
What's nice about this interaction model is that it's identical to interacting with any other object in Eve; a `click` event occuring or the `time` changing is exactly the same as, for instance, the `salary` attribute on an object changing, or adding a tag to an object. 
...
#### TodoMVC - [Code](https://github.com/witheve/Eve/blob/master/examples/todomvc.eve)

![Eve - TODO MVC]({{ site.url }}/images/evetodomvc.png)


#### Tic-Tac-Toe - [Code](https://github.com/witheve/Eve/blob/master/examples/tic-tac-toe.eve)

![Eve - Tic-Tac-Toe]({{ site.url }}/images/tic-tac-toe.gif)

#### Flappy Bird - [Code](https://github.com/witheve/Eve/blob/master/examples/flappy.eve)

![Eeve - Flappy Bird]({{ site.url }}/images/flippy-flop.gif)